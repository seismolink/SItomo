function [sel_data] = invert3Dbfgs(sel_data)
...
n2 = input('Define maximum number of Function Evaluation in Pre-Cycles (e.g., 5):  ');
...
[model,result] = DoInvert3Dbfgs(data,thetaflag,vflag,wflag,[z1 z2],nx,ny,nz,ix,iy,iz,edgeadd,sets,N1,N2,n1,n2,nevmax,initflag,strength_in,phi_in,theta_in,alpha,dec,showflag,printflag,[sel_data.SI_dir '/graphics/'],'invert2Dres',addname);
