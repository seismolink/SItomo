function [sel_data] = invert2Dmcmc(sel_data)
...
[model,result] = DoInvert2Dmcmc(data,thetaflag,vflag,[z1 z2],nx,ny,nz,edgeadd,nny,xstepini,phistepini,thetastepini,N1,N2,n1,n2,nevmax,initflag,strength_in,phi_in,theta_in,alpha,showflag,printflag,[sel_data.SI_dir '/graphics/'],'invert2Dres',addname);
