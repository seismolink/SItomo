function [si,dSKxTr,dSKphiTr,dSKthetaTr,ggTr] = ForwardSIsensitivity(per,par,AZIMUTH,x_1,y_1,z_1,X,Y,Z,omega,alpha_0,beta_0,strength_in,phi_in,theta_in,dec,vflag)
...
D = reshape(dot(wv,[X(:)-x_1 Y(:)-y_1 Z(:)-z_1]',1),M1,M2,M3);
...
% Prepare sensitivity kernels for strength of anisotropy
dSKxTr = (eps.*(eNFTxy.*gNF+eMFTxy.*gMF+eFFTxy.*gFF)+del.*(dNFTxy.*gNF+dMFTxy.*gMF+dFFTxy.*gFF)+gam.*(gNFTxy.*gNF+gMFTxy.*gMF+gFFTxy.*gFF)).*R.^dec;
...
dSKthetaTr = (eps.*(eNFTxy.*gNF+eMFTxy.*gMF+eFFTxy.*gFF)+del.*(dNFTxy.*gNF+dMFTxy.*gMF+dFFTxy.*gFF)+gam.*(gNFTxy.*gNF+gMFTxy.*gMF+gFFTxy.*gFF)).*R.^dec;

% Prepare sensitivity kernels for horizontal orientation of anisotropic tensor
% derivative for phi > s1 = -s2; s2 = s1;
% Near Field
exR = 6.*(-5.*p1.*(p1.^2+p2.^2+p3.^2-1)+2.*(5.*p1.^2-1).*s1.*(p2.*s2+p3.*s3)+p1.*(5.*p1.^2-3).*s1.^2+p1.*s2.*((5.*p2.^2-1).*s2+10.*p2.*p3.*s3)+p1.*(5.*p3.^2-1).*s3.^2).*(-s2.*(gg1.*wv2.*s2+gg1.*s3.*wv3+gg2.*wv1.*s2+gg3.*s3.*wv1)+s1.*(gg1.*wv2.*s1+gg2.*wv1.*s1)+wv2.*s1.*(gg2.*s2+gg3.*s3)+2.*s1.*s2.*(gg2.*wv2+gg3.*wv3)+gg2.*s1.*(wv2.*s2+s3.*wv3))+6.*(-2.*(5.*p1.^2-1).*s2.*(p2.*s2+p3.*s3)+2.*(5.*p1.^2-1).*p2.*s1.^2-2.*p1.*(5.*p1.^2-3).*s1.*s2+p1.*s1.*((5.*p2.^2-1).*s2+10.*p2.*p3.*s3)+p1.*(5.*p2.^2-1).*s1.*s2).*(s1.*(gg1.*wv2.*s2+gg1.*s3.*wv3+gg2.*wv1.*s2+gg3.*s3.*wv1)-(s1.^2.*(gg2.*wv2+gg3.*wv3))+(gg2.*s2+gg3.*s3).*(wv2.*s2+s3.*wv3));
eyR = 6.*(-5.*p2.*(p1.^2+p2.^2+p3.^2-1)+p2.*s1.*((5.*p1.^2-1).*s1+10.*p1.*p3.*s3)+2.*(5.*p2.^2-1).*s2.*(p1.*s1+p3.*s3)+p2.*(5.*p2.^2-3).*s2.^2+p2.*(5.*p3.^2-1).*s3.^2).*(-s2.*(gg1.*wv2.*s2+gg1.*s3.*wv3+gg2.*wv1.*s2+gg3.*s3.*wv1)+s1.*(gg1.*wv2.*s1+gg2.*wv1.*s1)+wv2.*s1.*(gg2.*s2+gg3.*s3)+2.*s1.*s2.*(gg2.*wv2+gg3.*wv3)+gg2.*s1.*(wv2.*s2+s3.*wv3))+6.*(-p2.*s2.*((5.*p1.^2-1).*s1+10.*p1.*p3.*s3)-(5.*p1.^2-1).*p2.*s1.*s2+2.*(5.*p2.^2-1).*s1.*(p1.*s1+p3.*s3)-2.*p1.*(5.*p2.^2-1).*s2.^2+2.*p2.*(5.*p2.^2-3).*s1.*s2).*(s1.*(gg1.*wv2.*s2+gg1.*s3.*wv3+gg2.*wv1.*s2+gg3.*s3.*wv1)-(s1.^2.*(gg2.*wv2+gg3.*wv3))+(gg2.*s2+gg3.*s3).*(wv2.*s2+s3.*wv3));
gxR = 6.*(-2.*(5.*p1.^2-1).*p2.*(s1.*(gg1.*wv2.*s2+gg1.*s3.*wv3+gg2.*wv1.*s2+gg3.*s3.*wv1)-2.*s1.*s2.*(gg1.*wv2+gg2.*wv1)+s2.*(gg1.*wv2.*s1+gg2.*wv1.*s1)-s2.*(gg2.*s3.*wv3-2.*gg3.*wv3.*s2+gg3.*s3.*wv2)-2.*gg3.*wv3.*s1.^2)-2.*(5.*p1.^2-1).*p3.*(s3.*(gg1.*wv2.*s1+gg2.*wv1.*s1)-2.*s1.*s2.*(gg1.*wv3+gg3.*wv1)+s1.^2.*(gg2.*wv3+gg3.*wv2)-s2.*(s2.*(gg2.*wv3+gg3.*wv2)-2.*gg2.*s3.*wv2))+2.*p1.*(5.*p2.^2-1).*(-s3.*s2.*(gg1.*wv3+gg3.*wv1)+2.*s1.*s2.*(gg2.*wv2+gg3.*wv3)-2.*gg2.*wv2.*s1.*s2)+5.*p1.*p2.*p3.*(2.*s3.*s2.*(gg1.*wv2+gg2.*wv1)-2.*s1.^2.*(gg1.*wv3+gg3.*wv1)+2.*s2.^2.*(gg1.*wv3+gg3.*wv1)+4.*gg1.*s3.*wv1.*s1-4.*s1.*s2.*(gg2.*wv3+gg3.*wv2))+2.*p1.*(5.*p3.^2-1).*((gg2.*s1-gg1.*s2).*(wv1.*s1+wv2.*s2)+(gg1.*s1+gg2.*s2).*(wv2.*s1-wv1.*s2))+2.*p1.*(5.*p1.^2-3).*(wv2.*s1.*(gg2.*s2+gg3.*s3)-2.*s1.*s2.*(gg2.*wv2+gg3.*wv3)+gg2.*s1.*(wv2.*s2+s3.*wv3)));
gyR = 6.*(-2.*p1.*(5.*p2.^2-1).*(s1.*(gg1.*wv2.*s2+gg1.*s3.*wv3+gg2.*wv1.*s2+gg3.*s3.*wv1)-2.*s1.*s2.*(gg1.*wv2+gg2.*wv1)+s2.*(gg1.*wv2.*s1+gg2.*wv1.*s1)-s2.*(gg2.*s3.*wv3-2.*gg3.*wv3.*s2+gg3.*s3.*wv2)-2.*gg3.*wv3.*s1.^2)-10.*p1.*p2.*p3.*(s3.*(gg1.*wv2.*s1+gg2.*wv1.*s1)-2.*s1.*s2.*(gg1.*wv3+gg3.*wv1)+s1.^2.*(gg2.*wv3+gg3.*wv2)-s2.*(s2.*(gg2.*wv3+gg3.*wv2)-2.*gg2.*s3.*wv2))+(5.*p2.^2-1).*p3.*(2.*s3.*s2.*(gg1.*wv2+gg2.*wv1)-2.*s1.^2.*(gg1.*wv3+gg3.*wv1)+2.*s2.^2.*(gg1.*wv3+gg3.*wv1)+4.*gg1.*s3.*wv1.*s1-4.*s1.*s2.*(gg2.*wv3+gg3.*wv2))+2.*p2.*(5.*p2.^2-3).*(-s3.*s2.*(gg1.*wv3+gg3.*wv1)+2.*s1.*s2.*(gg2.*wv2+gg3.*wv3)-2.*gg2.*wv2.*s1.*s2)+2.*p2.*(5.*p3.^2-1).*((gg2.*s1-gg1.*s2).*(wv1.*s1+wv2.*s2)+(gg1.*s1+gg2.*s2).*(wv2.*s1-wv1.*s2))+2.*(5.*p1.^2-1).*p2.*(wv2.*s1.*(gg2.*s2+gg3.*s3)-2.*s1.*s2.*(gg2.*wv2+gg3.*wv3)+gg2.*s1.*(wv2.*s2+s3.*wv3)));
eNFTxy = (cosd(inc)).*cos(Alpha2).*2.*alpha_0.^2./beta_0.^2.*exR+(cosd(inc)).*sin(Alpha).*2.*alpha_0.^2./beta_0.^2.*eyR;
gNFTxy = 2.*((cosd(inc)).*cos(Alpha2).*gxR+(cosd(inc)).*sin(Alpha2).*gyR);
% Mid field
exR = 2.*((6.*p1.^3-4.*p1).*s1.^2-6.*p1.*(p1.^2+p2.^2+p3.^2-1)+3.*(4.*p1.^2-1).*s1.*(p2.*s2+p3.*s3)+p1.*s2.*((6.*p2.^2-1).*s2+12.*p2.*p3.*s3)+p1.*(6.*p3.^2-1).*s3.^2).*(-s2.*(gg1.*wv2.*s2+gg1.*s3.*wv3+gg2.*wv1.*s2+gg3.*s3.*wv1)+s1.*(gg1.*wv2.*s1+gg2.*wv1.*s1)+wv2.*s1.*(gg2.*s2+gg3.*s3)+2.*s1.*s2.*(gg2.*wv2+gg3.*wv3)+gg2.*s1.*(wv2.*s2+s3.*wv3))+2.*(-2.*(6.*p1.^3-4.*p1).*s1.*s2-3.*(4.*p1.^2-1).*s2.*(p2.*s2+p3.*s3)+3.*(4.*p1.^2-1).*p2.*s1.^2+p1.*s1.*((6.*p2.^2-1).*s2+12.*p2.*p3.*s3)+p1.*(6.*p2.^2-1).*s1.*s2).*(s1.*(gg1.*wv2.*s2+gg1.*s3.*wv3+gg2.*wv1.*s2+gg3.*s3.*wv1)-(s1.^2.*(gg2.*wv2+gg3.*wv3))+(gg2.*s2+gg3.*s3).*(wv2.*s2+s3.*wv3));
eyR = 2.*(-6.*p2.*(p1.^2+p2.^2+p3.^2-1)+p2.*s1.*((6.*p1.^2-1).*s1+12.*p1.*p3.*s3)+3.*(4.*p2.^2-1).*s2.*(p1.*s1+p3.*s3)+2.*p2.*(3.*p2.^2-2).*s2.^2+p2.*(6.*p3.^2-1).*s3.^2).*(-s2.*(gg1.*wv2.*s2+gg1.*s3.*wv3+gg2.*wv1.*s2+gg3.*s3.*wv1)+s1.*(gg1.*wv2.*s1+gg2.*wv1.*s1)+wv2.*s1.*(gg2.*s2+gg3.*s3)+2.*s1.*s2.*(gg2.*wv2+gg3.*wv3)+gg2.*s1.*(wv2.*s2+s3.*wv3))+2.*(-p2.*s2.*((6.*p1.^2-1).*s1+12.*p1.*p3.*s3)-(6.*p1.^2-1).*p2.*s1.*s2+3.*(4.*p2.^2-1).*s1.*(p1.*s1+p3.*s3)-3.*p1.*(4.*p2.^2-1).*s2.^2+4.*p2.*(3.*p2.^2-2).*s1.*s2).*(s1.*(gg1.*wv2.*s2+gg1.*s3.*wv3+gg2.*wv1.*s2+gg3.*s3.*wv1)-(s1.^2.*(gg2.*wv2+gg3.*wv3))+(gg2.*s2+gg3.*s3).*(wv2.*s2+s3.*wv3));
gxR = -4.*(3.*p1.^2-1).*p2.*(s1.*(gg1.*wv2.*s2+gg1.*s3.*wv3+gg2.*wv1.*s2+gg3.*s3.*wv1)-2.*s1.*s2.*(gg1.*wv2+gg2.*wv1)+s2.*(gg1.*wv2.*s1+gg2.*wv1.*s1)-s2.*(gg2.*s3.*wv3-2.*gg3.*wv3.*s2+gg3.*s3.*wv2)-2.*gg3.*wv3.*s1.^2)-2.*(6.*p1.^2-1).*p2.*(s1.*(gg1.*wv2.*s2+gg1.*s3.*wv3+gg2.*wv1.*s2+gg3.*s3.*wv1)-2.*s1.*s2.*(gg1.*wv2+gg2.*wv1)+s2.*(gg1.*wv2.*s1+gg2.*wv1.*s1)-s2.*(gg2.*s3.*wv3-2.*gg3.*wv3.*s2+gg3.*s3.*wv2)-2.*gg3.*wv3.*s1.^2)-4.*(3.*p1.^2-1).*p3.*(s3.*(gg1.*wv2.*s1+gg2.*wv1.*s1)-2.*s1.*s2.*(gg1.*wv3+gg3.*wv1)+s1.^2.*(gg2.*wv3+gg3.*wv2)-s2.*(s2.*(gg2.*wv3+gg3.*wv2)-2.*gg2.*s3.*wv2))-2.*(6.*p1.^2-1).*p3.*(s3.*(gg1.*wv2.*s1+gg2.*wv1.*s1)-2.*s1.*s2.*(gg1.*wv3+gg3.*wv1)+s1.^2.*(gg2.*wv3+gg3.*wv2)-s2.*(s2.*(gg2.*wv3+gg3.*wv2)-2.*gg2.*s3.*wv2))+4.*p1.*(6.*p2.^2-1).*(-s3.*s2.*(gg1.*wv3+gg3.*wv1)+2.*s1.*s2.*(gg2.*wv2+gg3.*wv3)-2.*gg2.*wv2.*s1.*s2)+12.*p1.*p2.*p3.*(2.*s3.*s2.*(gg1.*wv2+gg2.*wv1)-2.*s1.^2.*(gg1.*wv3+gg3.*wv1)+2.*s2.^2.*(gg1.*wv3+gg3.*wv1)+4.*gg1.*s3.*wv1.*s1-4.*s1.*s2.*(gg2.*wv3+gg3.*wv2))+4.*p1.*(6.*p3.^2-1).*((gg2.*s1-gg1.*s2).*(wv1.*s1+wv2.*s2)+(gg1.*s1+gg2.*s2).*(wv2.*s1-wv1.*s2))+8.*p1.*(3.*p1.^2-2).*(wv2.*s1.*(gg2.*s2+gg3.*s3)-2.*s1.*s2.*(gg2.*wv2+gg3.*wv3)+gg2.*s1.*(wv2.*s2+s3.*wv3));
gyR = -4.*p1.*(3.*p2.^2-1).*(s1.*(gg1.*wv2.*s2+gg1.*s3.*wv3+gg2.*wv1.*s2+gg3.*s3.*wv1)-2.*s1.*s2.*(gg1.*wv2+gg2.*wv1)+s2.*(gg1.*wv2.*s1+gg2.*wv1.*s1)-s2.*(gg2.*s3.*wv3-2.*gg3.*wv3.*s2+gg3.*s3.*wv2)-2.*gg3.*wv3.*s1.^2)-2.*p1.*(6.*p2.^2-1).*(s1.*(gg1.*wv2.*s2+gg1.*s3.*wv3+gg2.*wv1.*s2+gg3.*s3.*wv1)-2.*s1.*s2.*(gg1.*wv2+gg2.*wv1)+s2.*(gg1.*wv2.*s1+gg2.*wv1.*s1)-s2.*(gg2.*s3.*wv3-2.*gg3.*wv3.*s2+gg3.*s3.*wv2)-2.*gg3.*wv3.*s1.^2)-24.*p1.*p2.*p3.*(s3.*(gg1.*wv2.*s1+gg2.*wv1.*s1)-2.*s1.*s2.*(gg1.*wv3+gg3.*wv1)+s1.^2.*(gg2.*wv3+gg3.*wv2)-s2.*(s2.*(gg2.*wv3+gg3.*wv2)-2.*gg2.*s3.*wv2))+2.*(3.*p2.^2-1).*p3.*(2.*s3.*s2.*(gg1.*wv2+gg2.*wv1)-2.*s1.^2.*(gg1.*wv3+gg3.*wv1)+2.*s2.^2.*(gg1.*wv3+gg3.*wv1)+4.*gg1.*s3.*wv1.*s1-4.*s1.*s2.*(gg2.*wv3+gg3.*wv2))+(6.*p2.^2-1).*p3.*(2.*s3.*s2.*(gg1.*wv2+gg2.*wv1)-2.*s1.^2.*(gg1.*wv3+gg3.*wv1)+2.*s2.^2.*(gg1.*wv3+gg3.*wv1)+4.*gg1.*s3.*wv1.*s1-4.*s1.*s2.*(gg2.*wv3+gg3.*wv2))+8.*p2.*(3.*p2.^2-2).*(-s3.*s2.*(gg1.*wv3+gg3.*wv1)+2.*s1.*s2.*(gg2.*wv2+gg3.*wv3)-2.*gg2.*wv2.*s1.*s2)+4.*p2.*(6.*p3.^2-1).*((gg2.*s1-gg1.*s2).*(wv1.*s1+wv2.*s2)+(gg1.*s1+gg2.*s2).*(wv2.*s1-wv1.*s2))+4.*(6.*p1.^2-1).*p2.*(wv2.*s1.*(gg2.*s2+gg3.*s3)-2.*s1.*s2.*(gg2.*wv2+gg3.*wv3)+gg2.*s1.*(wv2.*s2+s3.*wv3));
eMFTxy = (cosd(inc)).*cos(Alpha2).*2.*alpha_0.^2./beta_0.^2.*exR+(cosd(inc)).*sin(Alpha).*2.*alpha_0.^2./beta_0.^2.*eyR;
gMFTxy = 2.*((cosd(inc)).*cos(Alpha2).*gxR+(cosd(inc)).*sin(Alpha2).*gyR);
% Far field
exR = 2.*(-p1.*(p1.^2+p2.^2-p3.^2.*s3.^2+p3.^2-1)+(2.*p1.^2-1).*s1.*(p2.*s2+p3.*s3)+p1.*(p1.^2-1).*s1.^2+p1.*p2.*s2.*(p2.*s2+2.*p3.*s3)).*(-s2.*(gg1.*wv2.*s2+gg1.*s3.*wv3+gg2.*wv1.*s2+gg3.*s3.*wv1)+s1.*(gg1.*wv2.*s1+gg2.*wv1.*s1)+wv2.*s1.*(gg2.*s2+gg3.*s3)+2.*s1.*s2.*(gg2.*wv2+gg3.*wv3)+gg2.*s1.*(wv2.*s2+s3.*wv3))+2.*(-(2.*p1.^2-1).*s2.*(p2.*s2+p3.*s3)+(2.*p1.^2-1).*p2.*s1.^2-2.*p1.*(p1.^2-1).*s1.*s2+p1.*p2.^2.*s1.*s2+p1.*p2.*s1.*(p2.*s2+2.*p3.*s3)).*(s1.*(gg1.*wv2.*s2+gg1.*s3.*wv3+gg2.*wv1.*s2+gg3.*s3.*wv1)-(s1.^2.*(gg2.*wv2+gg3.*wv3))+(gg2.*s2+gg3.*s3).*(wv2.*s2+s3.*wv3));
eyR = 2.*(-p2.*(p1.^2+p2.^2-p3.^2.*s3.^2+p3.^2-1)+(2.*p2.^2-1).*s2.*(p1.*s1+p3.*s3)+p1.*p2.*s1.*(p1.*s1+2.*p3.*s3)+p2.*(p2.^2-1).*s2.^2).*(-s2.*(gg1.*wv2.*s2+gg1.*s3.*wv3+gg2.*wv1.*s2+gg3.*s3.*wv1)+s1.*(gg1.*wv2.*s1+gg2.*wv1.*s1)+wv2.*s1.*(gg2.*s2+gg3.*s3)+2.*s1.*s2.*(gg2.*wv2+gg3.*wv3)+gg2.*s1.*(wv2.*s2+s3.*wv3))+2.*(p1.^2.*(-p2).*s1.*s2+(2.*p2.^2-1).*s1.*(p1.*s1+p3.*s3)-p1.*(2.*p2.^2-1).*s2.^2-p1.*p2.*s2.*(p1.*s1+2.*p3.*s3)+2.*p2.*(p2.^2-1).*s1.*s2).*(s1.*(gg1.*wv2.*s2+gg1.*s3.*wv3+gg2.*wv1.*s2+gg3.*s3.*wv1)-(s1.^2.*(gg2.*wv2+gg3.*wv3))+(gg2.*s2+gg3.*s3).*(wv2.*s2+s3.*wv3));
gxR = p1.^2.*p2.*(-2.*s3.*s1.*(gg1.*wv3+gg3.*wv1)+2.*s3.*s2.*(gg2.*wv3+gg3.*wv2)+4.*gg3.*wv3.*s1.^2-4.*gg3.*wv3.*s2.^2)+(p1.^2-1).*p2.*(-2.*s3.*s1.*(gg1.*wv3+gg3.*wv1)+2.*s3.*s2.*(gg2.*wv3+gg3.*wv2)+4.*gg3.*wv3.*s1.^2-4.*gg3.*wv3.*s2.^2)+p1.^2.*p3.*(-2.*s3.*s1.*(gg1.*wv2+gg2.*wv1)+4.*s1.*s2.*(gg1.*wv3+gg3.*wv1)-2.*s1.^2.*(gg2.*wv3+gg3.*wv2)+2.*s2.^2.*(gg2.*wv3+gg3.*wv2)-4.*gg2.*s3.*wv2.*s2)+(p1.^2-1).*p3.*(-2.*s3.*s1.*(gg1.*wv2+gg2.*wv1)+4.*s1.*s2.*(gg1.*wv3+gg3.*wv1)-2.*s1.^2.*(gg2.*wv3+gg3.*wv2)+2.*s2.^2.*(gg2.*wv3+gg3.*wv2)-4.*gg2.*s3.*wv2.*s2)+4.*p1.*p2.^2.*(-wv1.*s2.*(gg1.*s1+gg3.*s3)-gg1.*s2.*(wv1.*s1+s3.*wv3)-2.*gg2.*wv2.*s1.*s2)+2.*p1.*p2.*p3.*(2.*s3.*s2.*(gg1.*wv2+gg2.*wv1)-2.*s1.^2.*(gg1.*wv3+gg3.*wv1)+2.*s2.^2.*(gg1.*wv3+gg3.*wv1)+4.*gg1.*s3.*wv1.*s1-4.*s1.*s2.*(gg2.*wv3+gg3.*wv2))+4.*p1.*p3.^2.*((gg2.*s1-gg1.*s2).*(wv1.*s1+wv2.*s2)+(gg1.*s1+gg2.*s2).*(wv2.*s1-wv1.*s2))+4.*(p1.^2-1).*p1.*(wv2.*s1.*(gg2.*s2+gg3.*s3)-2.*s1.*s2.*(gg2.*wv2+gg3.*wv3)+gg2.*s1.*(wv2.*s2+s3.*wv3));
gyR = p1.*p2.^2.*(-2.*s3.*s1.*(gg1.*wv3+gg3.*wv1)+2.*s3.*s2.*(gg2.*wv3+gg3.*wv2)+4.*gg3.*wv3.*s1.^2-4.*gg3.*wv3.*s2.^2)+p1.*(p2.^2-1).*(-2.*s3.*s1.*(gg1.*wv3+gg3.*wv1)+2.*s3.*s2.*(gg2.*wv3+gg3.*wv2)+4.*gg3.*wv3.*s1.^2-4.*gg3.*wv3.*s2.^2)-4.*p1.*p2.*p3.*(s3.*(gg1.*wv2.*s1+gg2.*wv1.*s1)-2.*s1.*s2.*(gg1.*wv3+gg3.*wv1)+s1.^2.*(gg2.*wv3+gg3.*wv2)-s2.*(s2.*(gg2.*wv3+gg3.*wv2)-2.*gg2.*s3.*wv2))+p2.^2.*p3.*(2.*s3.*s2.*(gg1.*wv2+gg2.*wv1)-2.*s1.^2.*(gg1.*wv3+gg3.*wv1)+2.*s2.^2.*(gg1.*wv3+gg3.*wv1)+4.*gg1.*s3.*wv1.*s1-4.*s1.*s2.*(gg2.*wv3+gg3.*wv2))+(p2.^2-1).*p3.*(2.*s3.*s2.*(gg1.*wv2+gg2.*wv1)-2.*s1.^2.*(gg1.*wv3+gg3.*wv1)+2.*s2.^2.*(gg1.*wv3+gg3.*wv1)+4.*gg1.*s3.*wv1.*s1-4.*s1.*s2.*(gg2.*wv3+gg3.*wv2))+4.*p2.*(p2.^2-1).*(-wv1.*s2.*(gg1.*s1+gg3.*s3)-gg1.*s2.*(wv1.*s1+s3.*wv3)-2.*gg2.*wv2.*s1.*s2)+4.*p2.*p3.^2.*((gg2.*s1-gg1.*s2).*(wv1.*s1+wv2.*s2)+(gg1.*s1+gg2.*s2).*(wv2.*s1-wv1.*s2))+4.*p1.^2.*p2.*(wv2.*s1.*(gg2.*s2+gg3.*s3)-2.*s1.*s2.*(gg2.*wv2+gg3.*wv3)+gg2.*s1.*(wv2.*s2+s3.*wv3));
eFFTxy = (cosd(inc)).*cos(Alpha2).*2.*alpha_0.^2./beta_0.^2.*exR+(cosd(inc)).*sin(Alpha).*2.*alpha_0.^2./beta_0.^2.*eyR;
gFFTxy = 2.*((cosd(inc)).*cos(Alpha2).*gxR+(cosd(inc)).*sin(Alpha2).*gyR);
dFFTxy = -eFFTxy;
dMFTxy = -eMFTxy;
...
dSKphiTr = (eps.*(eNFTxy.*gNF+eMFTxy.*gMF+eFFTxy.*gFF)+del.*(dNFTxy.*gNF+dMFTxy.*gMF+dFFTxy.*gFF)+gam.*(gNFTxy.*gNF+gMFTxy.*gMF+gFFTxy.*gFF)).*R.^dec;
