function [sel_data] = invert2Dgd(sel_data)
...
[model,result] = DoInvert2Dgd(data,thetaflag,vflag,wflag,[z1 z2],nx,ny,nz,ix,iz,edgeadd,nny,sets,xstepini,phistepini,thetastepini,N1,N2,n1,n2,nevmax,initflag,strength_in,phi_in,theta_in,alpha,dec,showflag,printflag,[sel_data.SI_dir '/graphics/'],'invert2Dres',addname);
